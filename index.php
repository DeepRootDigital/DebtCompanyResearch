			...
			<div class="tab-text">
				<div class="tab-one">
					...
					<div class="tab-two">
						...
						<div class="tab-content-wrap">
							<p>When you complete the simple 3 step form above we determine if you are a candidate for one of our companies. Certain companies only operate in certain states and with particular debt amounts which is why we ask the questions.</p>
